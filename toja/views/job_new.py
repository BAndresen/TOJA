...
class NewJob:
    def __init__(self, root, theme: Theme):
        ...
        self.main_job_frame.grid_columnconfigure(1, weight=1)
        self.main_job_frame.grid_rowconfigure(11, weight=1)

        self.position_title_entry = customtkinter.CTkEntry(self.main_job_frame)
        self.position_title_entry.grid(row=0, column=1, padx=(5, 20), pady=(20, 2),sticky="ew")
        ...
        self.company_name_entry.grid(row=1, column=1, padx=(5, 20), pady=2, sticky="ew")
        ...
        self.company_website_entry.grid(row=2, column=1, padx=(5, 20), pady=2, sticky="ew")
        ...
        self.job_location_entry.grid(row=3, column=1, padx=(5, 20), pady=2, sticky="ew")
        ...
        self.resume_version_entry.grid(row=4, column=1, padx=(5, 20), pady=2, sticky="ew")
        ...
        self.salary_top_entry.grid(row=5, column=1, padx=(5, 20), pady=2, sticky="ew")
        ...
        self.salary_bottom_entry.grid(row=6, column=1, padx=(5, 20), pady=2,sticky="ew")
        ...
        self.salary_type_entry.grid(row=7, column=1, padx=(5, 20), pady=2, sticky="ew")
        ...
        self.location_type_entry.grid(row=8, column=1, padx=(5, 20), pady=2, sticky="ew")
        ...
        self.job_type_entry.grid(row=9, column=1, padx=(5, 20), pady=2, sticky="ew")
        ...
        self.job_description_label.grid(row=10, column=0, pady=(10,0))

        self.job_description_textbox = customtkinter.CTkTextbox(self.main_job_frame)
        self.job_description_textbox.grid(row=11, column=0, columnspan=2, sticky="nsew", padx=20, pady=(2,20))
        ...
        self.event_info_frame.grid_columnconfigure(1, weight=1)
        self.event_info_frame.grid_rowconfigure(6, weight=1)

        self.event_entry = customtkinter.CTkComboBox(self.event_info_frame, values=constant.EVENT_TYPE, width=125)
        self.event_entry.grid(row=0, column=1, padx=(5, 20), pady=(20, 10), sticky="ew")
        ...
        self.day_entry.grid(row=1, column=1, padx=(5, 20), pady=10, sticky="ew")
        ...
        self.time_entry.grid(row=2, column=1, padx=(5, 20), pady=10, sticky="ew")
        ...
        self.note_entry.grid(row=6, column=0, padx=20, pady=(2,20), columnspan=2, sticky= 'nsew')
        self.note_label = customtkinter.CTkLabel(self.event_info_frame, text='Notes')
        self.note_label.grid(row=5, column=0, padx=(20, 5), pady=(10,2), sticky="e")
        ...
        self.submit_button.grid(row=2, column=1, padx=20, pady=20, sticky='e')
