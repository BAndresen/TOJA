...
class Report:
    def __init__(self, root, theme: Theme):
        ...
        self.main_frame = customtkinter.CTkFrame(self.report_window, fg_color=self.theme.listbox_bg)
        ...
        self.days_vs_event_frame.grid(row=1, column=0, columnspan=3, padx=10, pady=(0,10), sticky="nsew")

        self.de_graph = DayEvent()
        self.de_graph.bg_color = self.theme.main_frame
        ...
        self.event_pie_frame.grid(row=0, column=1, padx=0, pady=10, sticky="nsew")

        self.pie_graph = PieEvent()
        self.pie_graph.bg_color = self.theme.main_frame
        ...
        self.keyword_graph.bg_color = self.theme.main_frame
        ...
        self.info_frame = customtkinter.CTkFrame(self.left_combo_frame, fg_color=self.theme.listbox_bg)
        self.info_frame.grid(row=0, column=0, padx=10, pady=10, sticky="nsew")

        self.user_name_label = customtkinter.CTkLabel(self.info_frame, text='Username:',
        ...
        self.user_level.grid(row=2, column=1, sticky='w')
        ...
        self.user_point_gain_label = customtkinter.CTkLabel(self.info_frame, text='Points Earned:',
                                                            font=self.theme.header_two_font
                                                            )
        ...
        self.user_point_gain.grid(row=5, column=1, sticky='w')
        ...
        self.progress_graph.bg_color = self.theme.main_frame
